...
//     cout << "s0 is" << s0 << " and its length is " << s0.length() << endl ;
//     cout << "s0 is initialized as :" << s0 << endl ;
//     cout << "s1 is initialized as :" << s1 << endl ;
//     cout << "s2 is initialized as :" << s2 << endl ;
//     cout << "s3 is initialized as :" << s3 << endl ;
//     cout << "s4 is initialized as :" << s4 << endl ;
//     cout << "s5 is initialized as :" << s5 << endl ;
//     cout << "s6 is initialized as :" << s6 << endl ;
//     cout << "s7 is initialized as :" << s7 << endl ;
...
// Find
   ...
   if (position != string::npos)
    ...
    cout << "Searhed str pos" << position << endl ; 
